...
var CONFIG = (_CONFIG = {
  ...
  AUCTION: {
    ...
    // секунды
    AUTO_PASS_TIME: 10,
    // автоматический пропуск через N секунд
    BID_INCREMENT: 10,
  ...
  RESIDENCE: {
    MIN_PROPERTIES: 3,
    // минимальное количество свойств одного цвета для строительства
    RENT_MULTIPLIER: 2,
    // множитель арендной платы
    BUILD_COST: 500,
    // стоимость строительства резиденции
  ...
  IMPROVEMENT: {
    ...
    COST_PER_LEVEL: 200,
    RENT_INCREASE: 0.5,
    // увеличение аренды на 50% за уровень
  ...
  }, // Розовые
  {
    ...
    name: 'ГУМ',
    price: 1800,
    rent: [140, 700, 2000, 6000, 9000, 12000],
    color: 'pink',
    position: 11
  }, {
    id: 13,
    name: 'ЦУМ',
    price: 2000,
    rent: [160, 800, 2200, 6600, 9800, 14000],
    color: 'pink',
    position: 13
  }, // Оранжевые
  {
    ...
    price: 2400,
    rent: [200, 1000, 3000, 9000, 11250, 14000],
    color: 'orange',
    position: 15
  }, {
    id: 16,
  ...
  }, // Желтые
  {
    ...
    name: 'Крым',
    price: 3400,
    rent: [300, 1700, 5000, 11000, 13000, 15000],
    color: 'yellow',
    position: 23
  }, {
    id: 24,
    name: 'Казань',
    price: 3600,
    rent: [320, 1800, 5000, 12000, 14000, 16000],
    color: 'yellow',
    position: 24
  }, // Зеленые
  {
    ...
    name: 'Владивосток',
    price: 4200,
    rent: [550, 2200, 6600, 16000, 19500, 23000],
    color: 'green',
    position: 28
  }, // Синие
  {
    ...
    name: 'Байкал',
    price: 4400,
    rent: [600, 2400, 7200, 18000, 22000, 25000],
    color: 'blue',
    position: 29
  }, // Фиолетовые
  {
    ...
    name: 'Камчатка',
    price: 4600,
    rent: [700, 2800, 8400, 20000, 24000, 28000],
    color: 'purple',
    position: 31
  }, {
    id: 32,
    name: 'Магадан',
    price: 4800,
    rent: [800, 3200, 9600, 22000, 26000, 30000],
    color: 'purple',
    position: 32
  }, {
    id: 34,
    name: 'Якутск',
    price: 5000,
    rent: [900, 3600, 10800, 24000, 28000, 32000],
    color: 'purple',
    position: 34
  }, // Темно-синие (дорогие)
  {
    ...
    name: 'Транссиб',
    price: 5200,
    rent: [1000, 4000, 12000, 26000, 30000, 34000],
    color: 'darkblue',
    position: 35
  }, {
    id: 37,
    name: 'Космодром',
    price: 5400,
    rent: [1100, 4400, 13200, 28000, 32000, 36000],
    color: 'darkblue',
    position: 37
  }, {
    id: 39,
    name: 'Москва-Сити',
    price: 5600,
    rent: [1200, 4800, 14400, 30000, 34000, 38000],
    color: 'darkblue',
    position: 39
  }],
  ...
  TOKENS: [{
    id: 'matryoshka',
    name: 'Матрёшка',
    image: 'assets/tokens/matryoshka.png'
  }, {
    id: 'balalaika',
    name: 'Балалайка',
    image: 'assets/tokens/balalaika.png'
  }, {
    id: 'kremlin',
    name: 'Кремль',
    image: 'assets/tokens/kremlin.png'
  }, {
    id: 'samovar',
    name: 'Самовар',
    image: 'assets/tokens/samovar.png'
  }, {
    id: 'bear',
    name: 'Медведь',
    image: 'assets/tokens/bear.png'
  }, {
    id: 'troika',
    name: 'Тройка',
    image: 'assets/tokens/troika.png'
  }],
  // Погодные условия
  WEATHER_TYPES: [{
    id: 'sunny',
    ...
    name: 'Шторм',
    en_name: 'Stormy',
    effect: 'severe_reduction'
  }]
}, _defineProperty(_CONFIG, "ECONOMIC_EVENTS", [{
  id: 'boom',
  name: 'Экономический бум',
  en_name: 'Economic Boom',
  ...
  name: 'Дефляция',
  en_name: 'Deflation',
  effect: 'cost_decrease',
  multiplier: 0.8
}]), _defineProperty(_CONFIG, "CULTURAL_EVENTS", [{
  id: 'festival',
  name: 'Фестиваль',
  en_name: 'Festival',
  effect: 'rent_bonus',
  ...
  bonus: 250
}]), _defineProperty(_CONFIG, "SOUNDS", {
...
}), _defineProperty(_CONFIG, "DEFAULT_SETTINGS", {
  language: 'ru',
  soundEnabled: true,
  musicEnabled: true,
